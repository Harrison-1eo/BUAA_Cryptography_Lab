...
def input_value():
    ...
    key1_bin = bin(int(key1, 16))[2: ].rjust(64, '0')  
    key2_bin = bin(int(key2, 16))[2: ].rjust(64, '0')  
    return msg_bin, key1_bin, key2_bin, mode

if __name__ == '__main__':
    msg, key1, key2, mode = input_value()
    
    if mode == 1:
        msg = des_encrypt(msg, key1)
        print(hex(int(msg, 2))[2:].rjust(16, '0'))
        msg = des_decrypt(msg, key2)
        print(hex(int(msg, 2))[2:].rjust(16, '0'))
        ans = des_encrypt(msg, key1)
    elif mode == 0:
        msg = des_decrypt(msg, key1)
        msg = des_encrypt(msg, key2)
        ans = des_decrypt(msg, key1)
